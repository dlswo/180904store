<%@ page import="org.injae.domain.StoreVO" %>
<%@ page import="org.injae.StoreDAO" %>
        ...
        <section class="content">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box">
                        <span class="info-box-icon bg-white"><img src="../simg/<%=vo.getImg()%>" class="storeimg"></span>

                        <div class="info-box-content">
                            <span class="info-box-text"><a href="store_detail.jsp?sno=<%=vo.getSno()%>">리뷰 쓰기</a></span>
